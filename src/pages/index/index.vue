<template>
  <view
    >说明：本页面演示了仅依靠 history & location 对象实现页面路由功能，未使用
    vue-router 的功能</view
  >
  ...
  <nut-button type="default" @click="fetchApi"
    >fetchApi()调用接口请求方法</nut-button
  >
  ...
  <nut-button block type="default" @click="goToPage('/pages/vue-router/index')"
    >前往"vue-router"页面</nut-button
  >
</template>
